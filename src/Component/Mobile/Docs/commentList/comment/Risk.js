  ...
  return (
    <Container>
      ...
      <div className="text Roboto_20pt_Regular_L">
        ...
        platform background regarding the Recharge Token, and marketing measures
        taken to create the Recharge Token ecosystem. This document reflects the
        most up-to-date information as of the latest version, but it should be
        noted that this is not the final version. Therefore, this document can
        be changed, added to, and or have information deleted if necessary, in
        response to the market conditions under our discretion.
      </div>
      <div className="text Roboto_20pt_Regular_L">
        As this document is not a contract or agreement related to any
        investment activities, we do not offer, induce, solicit, and or collect
        anything from this document. Therefore, buyers of Recharge tokens or
        redemption points should consider all risks prior to investment and
        should not use this document as a basis for their investment decisions.
      </div>
      <div className="text Roboto_20pt_Regular_L">
        No one is obligated to enter into any sale or exchange of Recharge
        tokens and redemption points under any legally binding contract. If the
        sale, exchange, or related contract requires a legally binding contract,
        a separate contract will be made. If the contents of the contract and
      ...
      <div className="text Roboto_20pt_Regular_L">
        ...
        approved. In conclusion, we express that we are not responsible for any
        loss or potential losses taken through any errors, inconsistencies,
      ...
      <div className="text Roboto_20pt_Regular_L">
        ...
        event of any discrepancies in interpretation, prioritize the original
        Korean version.
      </div>
    </Container>
  );
